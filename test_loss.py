...
#
a = Variable(torch.FloatTensor([0.8, 1.31]), requires_grad=True)
t = Variable(torch.FloatTensor([1, -1]), requires_grad=False)
#
...
# print(t.grad)
#
test = gradcheck(new_hinge_loss, (a,t), eps=1e-4, atol=1e-4)
print(test)
